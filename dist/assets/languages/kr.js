...
const langs = {
    ...
    dennies: '데니',
    materials: '재료',
    NoSetAccount: '이 계정은 아직 설정되지 않았으므로 이 명령어를 사용할 수 없습니다!',
    AccountNotFound: '해당 계정을 찾을 수 없습니다!',
    AccountNotFoundDesc: '### 아래 정보가 설정되었는지 확인하세요\n- 쿠키: `<hasCookie>`\n- UID: `<hasUid>`',
    ...
    admin_RemoveFailUserOtherServer: '<user>가 설정한 메시지 채널이 이 서버에 없습니다',
    admin_RemoveSuccess: '삭제 성공',
    admin_RemoveSuccessMessage: '<user>의 메시지 알림이 <channel>에서 삭제되었습니다',
    ...
    admin_MoveSuccessMessage: '`<count>` 명의 사용자 메시지 알림이 <channel>로 이동되었습니다',
    ...
    note_Error_Description: '[전적](https://act.hoyolab.com/app/mihoyo-zzz-game-record/index.html#/zzz) 오른쪽 상단 설정에서 게임 데이터 공개를 활성화하세요!',
    ...
    NonDataDesc: '전투 기록은 약 1시간에 한 번씩 업데이트됩니다. 나중에 다시 시도해 주세요',
    EnemyWeakness: '적 약점',
    ...
    DeadlyAssault: '위국 강습',
    TotalScore: '총 점수',
    DeadlyTip: '총 점수는 랭킹에 사용되며, 랭킹은 30분마다 업데이트됩니다. 나중에 새로고침하세요',
    BattleRecord: '전투 기록',
    ChallengeTime: '도전 시간',
};
