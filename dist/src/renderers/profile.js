...
exports.handleProfileDraw = handleProfileDraw;
exports.drawMainImage = drawMainImage;
...
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'en-us.ttf'), 'EN');
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'zh-tw.ttf'), 'TW');
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'zh-cn.ttf'), 'CN');
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'vi-vn.ttf'), 'VI');
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'ja-jp.ttf'), 'JP');
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'ko-kr.ttf'), 'KR');
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'fr-fr.ttf'), 'FR');
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)('.', 'src', '.', 'assets', 'Nunito-BlackItalic.ttf'), 'Nunito');
const fonts = {
    tw: 'TW',
    cn: 'CN',
    vi: 'VI',
