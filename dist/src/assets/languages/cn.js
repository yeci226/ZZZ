...
const langs = {
    ...
    AccountNotFoundDesc: '### 请确认以下资料是否已设置及是否正确\n- Cookie： `<hasCookie>`\n- UID： `<hasUid>`',
    ...
    note_Error: '用户资料未公开！',
    note_Error_Description: '请至 [战绩](https://act.hoyolab.com/app/mihoyo-zzz-game-record/index.html#/zzz) 右上角设定开启查看游戏资料！',
    ...
    redeem_ProcessingDesc: '剩余 <noRedeemedCodes> 个未兑换的礼包码，约剩余 <seconds> 秒',
    ...
    EnemyWeakness: '敌人弱点',
    TimeSpent: '耗时：请求 <requestTime> 秒 • 绘制 <drawTime> 秒',
    ShiyuDefense: '式与防卫战',
    RatingStats: '评级统计',
    FastestTime: '最快通关时间',
    Node1: '节点1',
