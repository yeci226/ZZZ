...
const createEmbed = (title: string, thumbnail: string, color: string, description: string = "") => {
...
const handleRemove = async (interaction: ChatInputCommandInteraction, tr: any, db: QuickDB) => {
...
const handleMove = async (interaction: ChatInputCommandInteraction, tr: any, db: QuickDB) => {
