const langs = {
  ...
  materials: "Matériel",
  NoSetAccount:
    "Cet Inter-nœud n'a pas fixé son compte, impossible d'utiliser cette commande!",
  AccountNotFound: "Impossible de trouver cet Inter-nœud!",
  AccountNotFoundDesc:
    "### Veuillez vérifier si les données suivantes sont correctes\n- Cookie: `<hasCookie>`\n- UID: `<hasUid>`",
  ...
  daily_NonAccountDesc:
    "Veuillez définir le compte avant d'utiliser cette commande.",
  ...
  account_View_Region: "Région",
  account_View_LastSync: "dernière synchro {time}",
  account_View_Linked: "Lié",
  account_View_LvShort: "Niv",
  account_View_NoStats: "(Aucune statistique)",
  ...
  admin_RemoveFailUserOtherServer:
    "Le canal de messages réglé par <user> n'est pas sur ce serveur.",
  admin_RemoveSuccess: "Retirer avec succès.",
  admin_RemoveSuccessMessage:
    "Le message pour <user> sur la <channel> a supprimé.",
  admin_MoveFail: "Échec du transfert",
  admin_MoveNoPermission:
    "Aucune autorisation pour envoyer un message à <channel>.",
  admin_MoveSuccess: "Succès du transfert",
  admin_MoveNoUser:
    "Il n'y a pas de paramètres de notification de message utilisateur pour ce serveur.",
  ...
  profileMain_Online: "En ligne",
  profileMain_Offline: "Hors ligne",
  profileMain_NoTitle: "Aucun titre défini",
  profileMain_Stats: "Statistiques du proxy",
  profileMain_ActiveDays: "Jours actifs",
  profileMain_Agents: "Agents",
  profileMain_Bangboo: "Bangbous",
  profileMain_Achievements: "Succès",
  profileMain_Badges: "Badges publics",
  profileCharacter_Level: "Niveau",
  profileCharacter_Cinema: "Cinéma",
  profileCharacter_AgentStats: "Stats de l’agent",
  profileCharacter_Skills: "Compétences",
  profileCharacter_BasicAttack: "Attaque normale",
  profileCharacter_SpecialAttack: "Attaque spéciale",
  profileCharacter_Dodge: "Esquive",
  profileCharacter_ChainAttack: "Enchaînement",
  profileCharacter_Assist: "Soutien",
  profileCharacter_CoreSkill: "Compétence fondamentale",
  profileCharacter_WEngine: "Amplificateur",
  profileCharacter_NoWEngine: "Aucun amplificateur équipé",
  profileCharacter_SlotUnequipped: "Emplacement <slot> · Non équipé",
  profileCharacter_ValidRolls: "Stats efficaces",
  profileCharacter_TwoPiece: "2 pièces",
  profileCharacter_FourPiece: "4 pièces",
  profileCharacter_DriveDiscs: "Disques de poussée",
  profileCharacter_TotalValidRolls: "Total des stats efficaces",
