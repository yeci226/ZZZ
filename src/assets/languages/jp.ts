const langs = {
  ...
  profileMain_Online: "オンライン",
  profileMain_Offline: "オフライン",
  profileMain_NoTitle: "称号未設定",
  profileMain_Stats: "プロキシ統計",
  profileMain_ActiveDays: "活動日数",
  profileMain_Agents: "エージェント数",
  profileMain_Bangboo: "ボンプ数",
  profileMain_Achievements: "アチーブメント数",
  profileMain_Badges: "公開バッジ",
  profileCharacter_Level: "レベル",
  profileCharacter_Cinema: "心象映画",
  profileCharacter_AgentStats: "エージェントステータス",
  profileCharacter_Skills: "スキル",
  profileCharacter_BasicAttack: "通常攻撃",
  profileCharacter_SpecialAttack: "特殊スキル",
  profileCharacter_Dodge: "回避",
  profileCharacter_ChainAttack: "連携スキル",
  profileCharacter_Assist: "支援スキル",
  profileCharacter_CoreSkill: "コアスキル",
  profileCharacter_WEngine: "音動機",
  profileCharacter_NoWEngine: "音動機未装備",
  profileCharacter_SlotUnequipped: "スロット <slot>・未装備",
  profileCharacter_ValidRolls: "有効ステータス",
  profileCharacter_TwoPiece: "2セット",
  profileCharacter_FourPiece: "4セット",
  profileCharacter_DriveDiscs: "ドライバディスク",
  profileCharacter_TotalValidRolls: "有効ステータス合計",
