const langs = {
  ...
  profileMain_Online: "Trực tuyến",
  profileMain_Offline: "Ngoại tuyến",
  profileMain_NoTitle: "Chưa đặt danh hiệu",
  profileMain_Stats: "Thống kê Proxy",
  profileMain_ActiveDays: "Ngày hoạt động",
  profileMain_Agents: "Đại lý",
  profileMain_Bangboo: "Bangboo",
  profileMain_Achievements: "Thành tựu",
  profileMain_Badges: "Huy hiệu công khai",
  profileCharacter_Level: "Cấp",
  profileCharacter_Cinema: "Cảnh Phim",
  profileCharacter_AgentStats: "Thuộc tính Đại Lý",
  profileCharacter_Skills: "Kỹ năng",
  profileCharacter_BasicAttack: "Tấn công thường",
  profileCharacter_SpecialAttack: "Chiến kỹ",
  profileCharacter_Dodge: "Né",
  profileCharacter_ChainAttack: "Liên kích",
  profileCharacter_Assist: "Hỗ trợ",
  profileCharacter_CoreSkill: "Kỹ năng cốt lõi",
  profileCharacter_WEngine: "Động Cơ W",
  profileCharacter_NoWEngine: "Chưa trang bị Động Cơ W",
  profileCharacter_SlotUnequipped: "Vị trí <slot> · Chưa trang bị",
  profileCharacter_ValidRolls: "Thuộc tính hiệu quả",
  profileCharacter_TwoPiece: "Bộ 2 món",
  profileCharacter_FourPiece: "Bộ 4 món",
  profileCharacter_DriveDiscs: "Đĩa Điều Khiển",
  profileCharacter_TotalValidRolls: "Tổng thuộc tính hiệu quả",
