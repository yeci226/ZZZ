const langs = {
  ...
  profileMain_Online: "Online",
  profileMain_Offline: "Offline",
  profileMain_NoTitle: "No Title Set",
  profileMain_Stats: "Proxy Statistics",
  profileMain_ActiveDays: "Active Days",
  profileMain_Agents: "Agents",
  profileMain_Bangboo: "Bangboo",
  profileMain_Achievements: "Achievements",
  profileMain_Badges: "Public Badges",
  profileCharacter_Level: "Level",
  profileCharacter_Cinema: "Cinema",
  profileCharacter_AgentStats: "Agent Stats",
  profileCharacter_Skills: "Skills",
  profileCharacter_BasicAttack: "Basic Attack",
  profileCharacter_SpecialAttack: "Special Attack",
  profileCharacter_Dodge: "Dodge",
  profileCharacter_ChainAttack: "Chain Attack",
  profileCharacter_Assist: "Assist",
  profileCharacter_CoreSkill: "Core Skill",
  profileCharacter_WEngine: "W-Engine",
  profileCharacter_NoWEngine: "No W-Engine Equipped",
  profileCharacter_SlotUnequipped: "Slot <slot> · Not Equipped",
  profileCharacter_ValidRolls: "Valid Rolls",
  profileCharacter_TwoPiece: "2-Pc",
  profileCharacter_FourPiece: "4-Pc",
  profileCharacter_DriveDiscs: "Drive Discs",
  profileCharacter_TotalValidRolls: "Total Valid Rolls",
