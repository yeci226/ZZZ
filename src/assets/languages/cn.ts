const langs = {
  ...
  profileMain_Online: "在线",
  profileMain_Offline: "离线",
  profileMain_NoTitle: "尚未设置称号",
  profileMain_Stats: "绳匠统计",
  profileMain_ActiveDays: "活跃天数",
  profileMain_Agents: "角色数量",
  profileMain_Bangboo: "邦布数量",
  profileMain_Achievements: "成就总数",
  profileMain_Badges: "公开徽章",
  profileCharacter_Level: "等级",
  profileCharacter_Cinema: "影画",
  profileCharacter_AgentStats: "角色属性",
  profileCharacter_Skills: "技能",
  profileCharacter_BasicAttack: "普通攻击",
  profileCharacter_SpecialAttack: "特殊技",
  profileCharacter_Dodge: "闪避",
  profileCharacter_ChainAttack: "连携技",
  profileCharacter_Assist: "支援技",
  profileCharacter_CoreSkill: "核心技",
  profileCharacter_WEngine: "音擎",
  profileCharacter_NoWEngine: "未装备音擎",
  profileCharacter_SlotUnequipped: "槽位 <slot>・未装备",
  profileCharacter_ValidRolls: "有效词条",
  profileCharacter_TwoPiece: "二件套",
  profileCharacter_FourPiece: "四件套",
  profileCharacter_DriveDiscs: "驱动盘",
  profileCharacter_TotalValidRolls: "总有效词条数",
  ...
  settings_RankPaintingDesc: "依影画等级自动选择意象影画。",
  settings_LocaleLabel: "语言",
  settings_LocaleDesc: "机器人将使用此语言回复你。",
  settings_On: "开",
  settings_Off: "关",
};
