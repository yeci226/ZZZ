const langs = {
  ...
  profileMain_Online: "온라인",
  profileMain_Offline: "오프라인",
  profileMain_NoTitle: "칭호 미설정",
  profileMain_Stats: "로프꾼 통계",
  profileMain_ActiveDays: "활동 일수",
  profileMain_Agents: "에이전트 수",
  profileMain_Bangboo: "Bangboo 수",
  profileMain_Achievements: "업적 수",
  profileMain_Badges: "공개 배지",
  profileCharacter_Level: "레벨",
  profileCharacter_Cinema: "시네마",
  profileCharacter_AgentStats: "에이전트 스탯",
  profileCharacter_Skills: "스킬",
  profileCharacter_BasicAttack: "일반 공격",
  profileCharacter_SpecialAttack: "특수 스킬",
  profileCharacter_Dodge: "회피",
  profileCharacter_ChainAttack: "콤보 공격",
  profileCharacter_Assist: "지원 스킬",
  profileCharacter_CoreSkill: "핵심 스킬",
  profileCharacter_WEngine: "W-엔진",
  profileCharacter_NoWEngine: "W-엔진 미장착",
  profileCharacter_SlotUnequipped: "슬롯 <slot>・미장착",
  profileCharacter_ValidRolls: "유효 옵션",
  profileCharacter_TwoPiece: "2세트",
  profileCharacter_FourPiece: "4세트",
  profileCharacter_DriveDiscs: "디스크 드라이브",
  profileCharacter_TotalValidRolls: "총 유효 옵션",
