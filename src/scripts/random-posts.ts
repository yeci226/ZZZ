...
const testUsername: string[] = ['測試嗯呢', '衝浪小龍', '網絡小白', '嚕嚕米', '包子超人', '草莓牛奶', '黑曜之刃', '去錦鯉麵館借開水泡麵', '紅豆派', '沼蝦先生', '一號機'];

const categories: string[] = ['general', 'official', 'discussion', 'question', 'info'];
...
function getRandomNumber(maxNum = 10): number {
