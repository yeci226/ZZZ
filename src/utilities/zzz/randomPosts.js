...
await db.set(
  ...
  Array.from({ length: 1000 }, (_, i) => ({
    ...
    post_author_name:
      testUsername[parseInt(getRandomNumber(11)) - 1] || "測試嗯呢嗯呢！",
    post_author_avatar: `./src/assets/images/interknot/IconInterKnot00${getRandomNumber(11)}.png`,
    post_title: testTitle[i] || "測試嗯呢嗯呢！",
    post_content: testTitle[i] || "測試嗯呢嗯呢！",
    post_image:
      `./src/assets/images/interknot/testCover0${parseInt(getRandomNumber(8))}.png` ||
      "./src/assets/images/interknot/postDefault.webp",
    post_category: categories[parseInt(getRandomNumber(5)) - 1] || "general",
    post_reactions: [],
    post_comments: [],
